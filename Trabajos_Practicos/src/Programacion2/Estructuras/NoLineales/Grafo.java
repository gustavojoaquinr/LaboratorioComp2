...
import Programacion2.Estructuras.Lineales.ListaSimple;
import Programacion2.Estructuras.Lineales.Nodo;
...
public class Grafo {
    ...
    public void construir(String[] vertices, String[][] aristas) {
        ...
        matrizConexiones = new int[aristas.length][aristas.length];
        ...
        for (int i = 0; i < aristas.length; i++) {
            ...
            matrizConexiones[iVertice1][iVertice2] = 1;
            matrizConexiones[iVertice2][iVertice1] = 1;
    ...
    public void conectar(String vertice1, String vertice2) {
        ...
        if (matrizConexiones[iVertice1][iVertice2] < 2 && matrizConexiones[iVertice2][iVertice1] < 2) {
            matrizConexiones[iVertice1][iVertice2]++;
            matrizConexiones[iVertice2][iVertice1]++;
        }
    }
    ...
    public void desconectar(String vertice1, String vertice2){
        ...
        if (matrizConexiones[iVertice1][iVertice2] == 2 && matrizConexiones[iVertice2][iVertice1] == 2) {
            ...
            matrizConexiones[iVertice1][iVertice2] = 0;
            matrizConexiones[iVertice2][iVertice1] = 0;
